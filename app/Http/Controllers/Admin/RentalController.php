...
class RentalController extends Controller
{
    ...
    public function store(Request $request){
        ...
        try {
            ...
            if($existingRental){
                return redirect()->route('admin.rental.list')->with('status', 'error')->with('message', 'The car is already booked for the selected dates.');
            }
        ...
        if ($rental->exists) {
            ...
            return redirect()->route('admin.rental.list')->with('status', 'success')->with('message', $message);
        } catch (Exception $e) {
            return redirect()->route('admin.rental.list')->with('status', 'error')->with('message', 'Operation failed: ' . $e->getMessage());
        }
    }
    ...
    public function delete($id){
        try{
            ...
            $rental->delete();
            return redirect()->route('admin.rental.list')->with('status', 'success')->with('message', 'Rental deleted successfully!');
