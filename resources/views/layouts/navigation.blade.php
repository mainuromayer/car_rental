    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if (Auth::user()->isAdmin())
                ...
                <x-responsive-nav-link :href="route('admin.customer.list')" :active="request()->is('admin/customer/*') || request()->is('admin/customer')">
                    {{ __('Customer') }}
                </x-responsive-nav-link>

                <x-responsive-nav-link :href="route('admin.car.list')" :active="request()->is('admin/car/*') || request()->is('admin/car')">
                    {{ __('Car') }}
                </x-responsive-nav-link>
