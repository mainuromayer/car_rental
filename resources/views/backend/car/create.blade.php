                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="car_type" name="car_type" type="text" class="mt-1 block w-full"
                                    :value="old('car_type')" autocomplete="car_type" />
                                <x-input-error :messages="$errors->get('car_type')" class="mt-2" />
                            </div>

                            <div>
                                <x-input-label for="daily_rent_price" :value="__('Daily Rent Price')" />
                                <x-text-input id="daily_rent_price" name="daily_rent_price" type="number"
                                    class="mt-1 block w-full" :value="old('daily_rent_price')" autocomplete="daily_rent_price" />
                            ...
                            <div>
                                ...
                                <img id="image_preview" src="{{ asset('images/images.png') }}" alt="Image Preview" class="mt-2 mb-2 object-cover" style="max-width: 200px; width: 200px; max-height: 200px; height: 200px;">
