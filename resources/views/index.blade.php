...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="{{ route('rentals') }}">Rentals</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route(name: 'register') }}" class="btn btn-outline-dark">SignUp</a>
                    </div>
                </div>
            </div>
        </nav>
    ...
    <footer class="text-center bg-dark py-3">
        <p class="text-white">&copy; {{ date('Y') }} Car Rental. All Rights Reserved.</p>
    </footer>
